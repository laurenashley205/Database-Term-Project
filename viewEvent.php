...
//now i think im going to change this to one "find event details" btn 
// similar to find rso, can search for an event
// it shows up at the bottom
// then add a function to comment
